...
public class QuickSettingsTilesStyle extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_QUICK_TILES_CUSTOM_COLOR = "qs_tiles_custom_color";
    ...
    CheckBoxPreference mQsTileCustomBG;
    ...
    private PreferenceScreen refreshSettings() {
		...
		mQsTileCustomBG = (CheckBoxPreference) findPreference(PREF_QUICK_TILES_CUSTOM_COLOR);
		mQsTileCustomBG.setChecked(Settings.System.getInt(
                getActivity().getContentResolver(),
                Settings.System.QUICK_TILES_CUSTOM_BG_COLOR, 0) == 1);
				
		mQsTileCustomBG.setOnPreferenceChangeListener(this);		
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mTilesPerRow) {
			...
			Helpers.restartSystemUI();		
            return true;
        } else if (preference == mQsTileCustomBG) {
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.QUICK_TILES_CUSTOM_BG_COLOR,
                    (Boolean) newValue ? 1 : 0);
            Helpers.restartSystemUI();		
            return true;
		}	
